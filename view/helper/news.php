...
echo "</tr><tr><td style='border-bottom:2px solid lightgray;' colspan=$colcount>&nbsp;</td></tr>";
   ...
   echo "<tr><td>";?>
   <a href='http://<?=$_SERVER['HTTP_HOST'].$site->dirs->path($did);?>'><?="<img onclick=\"alert (getimgsize('img".$article['imageid']."'));\" id='img".$article['imageid']."' src='/".IPATH."/".$images[$article['imageid']]['path']."/$version/".$images[$article['imageid']]['filename']."'></a></td></tr>";
